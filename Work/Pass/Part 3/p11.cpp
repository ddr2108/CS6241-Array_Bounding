...
namespace {
	...
	struct p11 : public FunctionPass {
		...
		virtual bool runOnFunction(Function &F){
			...
			std::map<BasicBlock*, std::set<int> > killedDef;	
			std::map<BasicBlock*, std::set<int> > usedDef;	
